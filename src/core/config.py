...
if _PYDANTIC_SETTINGS_AVAILABLE:
    ...
    class ARKConfig(BaseSettings):
        ...
        # ロールごとのGeminiモデル指定
        architect_model_gemini: str = "gemini-3.0-flash"
        coder_model_gemini: str = "gemini-3.0-flash"
        reviewer_model_gemini: str = "gemini-3.0-flash"
        reflector_model_gemini: str = "gemini-3.0-flash"
